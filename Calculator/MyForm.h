...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnNeg->Click += gcnew System::EventHandler(this, &MyForm::btnNeg_Click);
			// 
			// btn0
			// 
			...
			this->btnComma->Click += gcnew System::EventHandler(this, &MyForm::btnComma_Click);
			// 
			// btnEquals
			// 
			...
			this->btnInv->Click += gcnew System::EventHandler(this, &MyForm::btnInv_Click);
			// 
			// btnSquare
			// 
			...
			this->btnSquare->Click += gcnew System::EventHandler(this, &MyForm::btnSquare_Click);
			// 
			// btnSqrt
			// 
			...
			this->btnPerc->Click += gcnew System::EventHandler(this, &MyForm::btnPerc_Click);
			// 
			// btnCE
			// 
			...
			this->btnBckSpc->Click += gcnew System::EventHandler(this, &MyForm::btnBckSpc_Click);
			// 
			// lblBox
			// 
